...
#[test]
fn test_one_hundred_twelve() {
    assert_eq!(say::encode(112), String::from("one hundred twelve"));
}
...
#[test]
fn test_chunks_two_mil_twelve_thousand() {
    assert_eq!(say::chunks(2012000), vec![0,12,2]);
}
